...
SYSTEM_PROMPT = (
    ...
    "Supported actions:\n"
    "- open_app: target is the app name (e.g. WhatsApp, Slack, Chrome)\n"
    "- open_settings: target is the app name; opens the app then triggers its settings/preferences panel\n"
